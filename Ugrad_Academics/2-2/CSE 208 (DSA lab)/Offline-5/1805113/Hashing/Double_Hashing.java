public class Double_Hashing {
    ...
    int Hash_1(String key)
    {
        ...
        {
            value= value + (i+1)*436*(int)key.charAt(i);
        }
    ...
    {
        int value = ((int)key.charAt(1)+(int)key.charAt(3))/8;
    ...
    int Double_Hash(String key,int i)
    {
        ...
        int value = (Hash_1(key) + i*auxHash(key)) % (2*Total_items);
        //int value = (Hash_2(key) + i*auxHash(key)) % (table_size);
    ...
    void insert_item(String key) {
        ...
        //System.out.println("Adding DH "+probe_no);
